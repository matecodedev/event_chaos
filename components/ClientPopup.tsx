...
export const ClientPopup: React.FC<ClientPopupProps> = ({
  message,
  mood,
  onClose,
  mobile = false
  ...
  const getStyles = () => {
    switch (mood) {
      case 'ANGRY':
        return 'border-red-500 bg-red-950/90 shadow-red-900/50';
      case 'PANIC':
        return 'border-orange-500 bg-orange-950/90 shadow-orange-900/50';
      case 'HAPPY':
        return 'border-emerald-500 bg-emerald-950/90 shadow-emerald-900/50';
      default:
        return 'border-slate-500 bg-slate-900/90 shadow-slate-900/50';
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute inset-0 aaa-scanline-overlay pointer-events-none"
        ></div>
        ...
        <div className="flex items-start gap-4 relative z-10">
          ...
          <div aria-hidden="true" className="relative">
            <div
              className={`w-12 h-12 rounded-lg border-2 bg-black flex items-center justify-center overflow-hidden ${getStyles().split(' ')[0]}`}
            >
